//
//  ContentView.swift
//  print_demo_swift Watch App
//
//  Created by Jarvis Lu on 4/9/23.
//
...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            Button("Push to print") {
                let tcpClient = TCPClient(address: "192.168.12.66", port: 12346)
                print("jasndkjasn")
                let success = tcpClient.send(string: "Printed from Smart Watch")
                              if success {
                                  print("Sent hello")
                              } else {
